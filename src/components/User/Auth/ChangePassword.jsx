          ...
          >
            ...
            <div className="flex flex-col space-y-1">
              ...
              <input
                ...
                onChange={handleChange}
                pattern=".{6,20}"
                className="block w-full peer rounded-md border border-slate-300  px-3 py-2 text-sm placeholder-slate-400 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 focus:invalid:border-pink-500 focus:invalid:ring-pink-500"
              />
